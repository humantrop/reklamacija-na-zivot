...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="relative flex flex-col items-center justify-center px-6 text-center overflow-hidden min-h-[85vh]">
        {/* Background image */}
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat"
          style={{ backgroundImage: "url('/sve-ce-biti-ok.webp')" }}
        />
        {/* Overlay for text readability */}
        <div className="absolute inset-0 hero-overlay" />

        <div className="relative max-w-2xl z-10">
          <div className="inline-block mt-8 mb-6 rounded-full glass-card px-4 py-1.5 text-xs font-medium text-muted tracking-wider uppercase">
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            ...
            <div className="flex items-center justify-center gap-3">
              <Link
                href="/register"
                className="glass-card rounded-xl w-40 py-2.5 text-sm font-medium text-muted hover:text-foreground transition-all duration-300 hover:border-accent/30 text-center"
              >
                Napravi nalog
              </Link>
              <Link
            ...
            <p className="text-xs text-muted/60 mt-1">Uz nalog dobijaš značke, statistiku i sigurnije razgovore</p>
          </div>
        </div>
      </div>

      {/* Info boxes section with original background */}
      <div className="relative flex flex-col items-center px-6 text-center overflow-hidden">
        {/* Background orbs */}
